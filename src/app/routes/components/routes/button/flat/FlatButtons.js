    ...
    return (
        <div>
            <div className="jr-btn-group">
                ...
                <Button className="jr-btn" color="accent">Secondary</Button>
            ...
            <div className="jr-btn-group">
                ...
                <Button className="jr-btn" color="accent">
            ...
            <div>
                <Button raised className="jr-btn bg-primary text-uppercase text-white btn-block">Full Width Primary</Button>
                <Button raised className="jr-btn bg-secondary text-uppercase text-white btn-block">Full Width large button</Button>
                <Button raised className="jr-btn bg-white text-uppercase text-black btn-block">Full Width default button</Button>
