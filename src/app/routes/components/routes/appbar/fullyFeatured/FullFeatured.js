    ...
    render() {
        return (
            <AppBar className="app-main-header" position="static">
                <Toolbar>
                    <IconButton className="jr-menu-icon" color="contrast" aria-label="Menu">
                    ...
                    <Button dense className="ml-3 text-white d-none d-sm-block" color="contrast">Login</Button>
                    ...
                    <ul className="header-notifications list-inline ml-3 d-none d-sm-block">
                        ...
                        <li className="notification list-inline-item">
